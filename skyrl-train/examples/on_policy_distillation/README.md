...
## Quickstart
To get started, first setup the dataset from the DAPO example

```bash
uv run examples/algorithms/dapo/prepare_dapo_data.sh
```

Then, just make sure to set the path to your desired teacher model, and you're ready to get started!
