...
uv run --isolated --extra vllm -m examples.algorithms.dapo.main_dapo \
  ...
  trainer.run_name="qwen3_1.7b_base_aime_rl_baseline_dapo_temp1_topp1_lr_$LR" \
  trainer.export_path="$HOME/exports/qwen3_1.7b_base_aime_rl_baseline_dapo_temp1_topp1_lr_$LR" \
  trainer.hf_save_interval=20 \
  trainer.resume_mode=latest \
  trainer.max_ckpts_to_keep=3 \
  trainer.ckpt_path="$HOME/ckpts/qwen3_1.7b_base_aime_rl_baseline_dapo_temp1_topp1_lr_$LR" \
  $@