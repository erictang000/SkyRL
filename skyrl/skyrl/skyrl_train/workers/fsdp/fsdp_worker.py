...
from skyrl.skyrl_train.workers.model_wrapper import HFModelWrapper, get_llm_for_sequence_regression
from skyrl.skyrl_train.distributed.fsdp_strategy import FSDPStrategy
from skyrl.skyrl_train.utils import str_to_torch_dtype
from skyrl.skyrl_train.training_batch import TrainingInputBatch, TrainingOutputBatch
from skyrl.skyrl_train.distributed.fsdp_utils import fsdp_version, get_init_weight_context_manager
from skyrl.skyrl_train.workers.worker import (
    PolicyWorkerBase,
    CriticWorkerBase,
    RefWorkerBase,
)
from skyrl.skyrl_train.weight_sync import WeightExtractor, WeightChunk, LoraLoadRequest
from skyrl.skyrl_train.weight_sync.weight_extractor_utils import yield_module_grouped_chunks
...
class FSDPPolicyWorkerBase(PolicyWorkerBase):
    ...
    async def _save_lora_adapters_and_sync(self, peft_model, lora_sync_path, inference_engine_client):
        ...
        from skyrl.skyrl_train.distributed.fsdp_utils import collect_lora_params
