...
from skyrl.skyrl_train.config import SkyRLConfig, AlgorithmConfig
from skyrl.skyrl_train.dataset.replay_buffer import Experience
from skyrl.skyrl_train.distributed.dispatch import (
    ActorInfo,
    Dispatch,
    DispatchRegistry,
    MeshRank,
)
from skyrl.skyrl_train.distributed.strategy import DistributedStrategy
from skyrl.skyrl_train.distributed.ulysses import (
    apply_monkey_patch,
    set_ulysses_sequence_parallel_group,
)
from skyrl.skyrl_train.inference_engines.inference_engine_client import InferenceEngineClient
from skyrl.skyrl_train.env_vars import _SKYRL_USE_NEW_INFERENCE
from skyrl.skyrl_train.training_batch import TrainingInputBatch, TrainingOutputBatch
from skyrl.skyrl_train.utils import (
    get_ray_pg_ready_with_timeout,
    get_reordered_bundle_indices,
    ray_noset_visible_devices,
)
from skyrl.skyrl_train.env_vars import (
    SKYRL_RAY_PG_TIMEOUT_IN_S,
    SKYRL_WORKER_NCCL_TIMEOUT_IN_S,
)
from skyrl.skyrl_train.utils.io import io
from skyrl.skyrl_train.utils.ppo_utils import (
    PolicyLossRegistry,
    compute_approx_kl,
    ppo_critic_loss,
)
from skyrl.skyrl_train.utils.torch_utils import masked_mean
from skyrl.skyrl_train.utils.utils import configure_ray_worker_logging
from skyrl.skyrl_train.workers.worker_utils import BatchIterator, reduce_metrics, all_reduce_metrics

_SET_AFFINITY = False

if TYPE_CHECKING:
    from skyrl.skyrl_train.inference_engines.remote_inference_client import RemoteInferenceClient
...
class Worker(DistributedTorchRayActor):
    def __init__(self, cfg: Union[SkyRLConfig, DictConfig], *args, **kwargs):
        from skyrl.skyrl_train.weight_sync import get_transfer_strategy_cls
