...
from skyrl.skyrl_train.config.config import MegatronDDPConfig, get_config_as_dict
from skyrl.skyrl_train.distributed.megatron.optimizer import (
    init_megatron_optim_config,
    get_megatron_optimizer,
    get_megatron_optimizer_param_scheduler,
)
from skyrl.skyrl_train.distributed.dispatch import MeshRank
from skyrl.skyrl_train.distributed.megatron.megatron_strategy import MegatronStrategy
from skyrl.skyrl_train.distributed.megatron.megatron_utils import print_model_size, broadcast_object_across_pp_ranks
from skyrl.skyrl_train.utils.utils import update_model_config, str_to_torch_dtype
from skyrl.skyrl_train.env_vars import SKYRL_WORKER_NCCL_TIMEOUT_IN_S
...
from skyrl.skyrl_train.workers.worker import (
    PolicyWorkerBase,
    RefWorkerBase,
    CriticWorkerBase,
)
from skyrl.skyrl_train.workers.megatron.megatron_model_wrapper import MegatronModelWrapper
from skyrl.skyrl_train.utils.profiler import Profiler
from skyrl.skyrl_train.weight_sync import WeightExtractor, WeightChunk
...
class MegatronPolicyWorkerBase(MegatronWorker, PolicyWorkerBase):
    ...
    def init_model(self, model_path, num_training_steps: int = 1e9):
        ...
        from skyrl.skyrl_train.weight_sync import CudaIpcTransferStrategy
