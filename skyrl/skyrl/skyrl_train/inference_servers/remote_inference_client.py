...
from skyrl.skyrl_train.inference_engines.base import InferenceEngineInput, InferenceEngineOutput

if TYPE_CHECKING:
    from skyrl.skyrl_train.weight_sync import BroadcastInitInfo, WeightUpdateRequest
