...
from skyrl.skyrl_train.weight_sync import WeightLoader, WeightUpdateRequest, BroadcastWeightUpdateRequest
...
class RemoteWeightLoader(WeightLoader):
    ...
    async def init_communicator(self, init_info: "WeightSyncInitInfo") -> Dict[str, Any]:
        ...
        """
        from skyrl.skyrl_train.weight_sync import BroadcastTransferStrategy
