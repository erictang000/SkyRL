...
if TYPE_CHECKING:
    from skyrl.skyrl_train.weight_sync.transfer_strategy import WeightSyncInitInfo
from ray.util.placement_group import PlacementGroupSchedulingStrategy, placement_group

from skyrl.skyrl_train.inference_engines.base import (
    InferenceEngineInput,
    InferenceEngineInterface,
    InferenceEngineOutput,
)
from skyrl.skyrl_train.inference_engines.utils import get_rendezvous_addr_port
from skyrl.skyrl_train.weight_sync import WeightUpdateRequest
...
def create_ray_wrapped_inference_engines(
    ...
    if backend == "vllm":
        ...
        from skyrl.skyrl_train.inference_engines.vllm.vllm_engine import (
            AsyncVLLMRayActor,
            VLLMRayActor,
        )
        ...
        if backend == "vllm":
            ...
            for dp_rank in range(data_parallel_size):
                ...
                engine = actor_class.options(
                    ...
                    worker_extension_cls="skyrl.skyrl_train.inference_engines.vllm.vllm_engine.WorkerWrap",
            ...
            def get_sglang_engine():
                ...
                from skyrl.skyrl_train.inference_engines.sglang.sglang_engine import (
                    SGLangRayActor,
                )
