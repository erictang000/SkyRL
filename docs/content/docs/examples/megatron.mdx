...
To get started, you can follow the instructions for installing via Docker in the [Installation Guide](../getting-started/installation) page, but using the `novaskyai/skyrl-train-ray-2.56.0-py3.12-cu13.0-megatron` image instead of the default image.
