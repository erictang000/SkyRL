...
uv run --directory . --isolated --extra dev --extra fsdp pytest -s tests/backends/skyrl_train/gpu/gpu_ci -m "not (integrations or megatron or mooncake)" --ignore=tests/backends/skyrl_train/gpu/gpu_ci/megatron --ignore=tests/backends/skyrl_train/gpu/gpu_ci/patches/megatron
...
uv run --directory . --isolated --extra dev --extra fsdp --extra mooncake pytest -s tests/backends/skyrl_train/gpu/gpu_ci -m "mooncake" --ignore=tests/backends/skyrl_train/gpu/gpu_ci/megatron --ignore=tests/backends/skyrl_train/gpu/gpu_ci/patches/megatron
