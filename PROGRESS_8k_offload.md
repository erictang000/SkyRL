...
| 9 (train batch) | pass@16 **0.648** | -0.701 | 0.386 | 1599 (26.7 min, fastest) | _in progress_ | _pending_ | New peak (since step 2). raw_reward best since step 1. mean_pos highest yet (0.386). Mean steps 1-9: 0.604. Eval@10 next. |
