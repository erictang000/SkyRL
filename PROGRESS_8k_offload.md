...
| 10 (train batch) | pass@16 **0.742** | -0.526 | 0.425 | 1642 (27.4 min) | _in progress_ | _pending_ | **Big jump: +9pp over step 9, +16pp over step 1.** raw_reward -0.526 (best yet), mean_pos 0.425 (peak). RL gradient now clearly emerging. Mean steps 1-10: 0.617. Eval@10 next. |
